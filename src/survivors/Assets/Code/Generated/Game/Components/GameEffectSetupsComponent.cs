...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Armaments.ArmamentsComponents.EffectSetups effectSetups { get { return (Code.Gameplay.Features.Armaments.ArmamentsComponents.EffectSetups)GetComponent(GameComponentsLookup.EffectSetups); } }
    ...
    public GameEntity AddEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effects.EffectSetup> newValue) {
        ...
        var component = (Code.Gameplay.Features.Armaments.ArmamentsComponents.EffectSetups)CreateComponent(index, typeof(Code.Gameplay.Features.Armaments.ArmamentsComponents.EffectSetups));
