...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Armaments.ArmamentsComponents.StatusSetups statusSetups { get { return (Code.Gameplay.Features.Armaments.ArmamentsComponents.StatusSetups)GetComponent(GameComponentsLookup.StatusSetups); } }
    ...
    public GameEntity AddStatusSetups(System.Collections.Generic.List<Code.Gameplay.Features.Statuses.StatusSetup> newValue) {
        ...
        var component = (Code.Gameplay.Features.Armaments.ArmamentsComponents.StatusSetups)CreateComponent(index, typeof(Code.Gameplay.Features.Armaments.ArmamentsComponents.StatusSetups));
